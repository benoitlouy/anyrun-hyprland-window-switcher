// The code present in this file was copied from the anyrun applications plugin
// The original source code is available at
// https://github.com/Kirottu/anyrun/tree/master/plugins/applications
...
impl DesktopEntry {
    fn from_dir_entry(entry: &fs::DirEntry) -> Vec<Self> {
...
pub fn scrubber() -> Result<Vec<DesktopEntry>, Box<dyn std::error::Error>> {
    ...
    .filter_map(|entry| {
        ...
        let entries = DesktopEntry::from_dir_entry(&entry);
        Some(
            entries
                .into_iter()
